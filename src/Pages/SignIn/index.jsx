  ...
  const renderLogIn = () => {
    return (
      <div className="flex flex-col w-80">
        ...
        <Link to='/'>
          <button className="bg-[#200a3e] disabled:bg-black/40 text-white w-full rounded-lg py-3 mt-4 mb-2" disabled={!hasUserAnAccount} onClick={() => handleSignIn()}>Log in</button>
        </Link>
